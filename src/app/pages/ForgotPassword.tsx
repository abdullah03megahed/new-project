    ...
    <div className="min-h-[calc(100vh-80px)] bg-[#B19CD9]/10 flex items-center justify-center p-4">
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-[#34495E]">Forgot Password</CardTitle>
          <CardDescription>
        ...
        <CardContent>
          {sent ? (
            <div className="text-center space-y-4">
              ...
              <p className="text-[#34495E] font-medium">Check your email</p>
              ...
              <p className="text-[#717182] text-sm">
                ...
                <button
                  ...
                  className="text-[#00A5A7] hover:underline"
                >
                  try again
                </button>.
              </p>
              <Link to="/login">
                <Button className="w-full bg-[#FF6F61] hover:bg-[#FF6F61]/90 text-white mt-2">
                  Back to Sign In
                </Button>
              </Link>
            </div>
